...
module.exports.run = async function({ api, args, Users, event}) {
 ...
 setTimeout(() => {a({body: "এই মুরগি খাংকির পোলা হৃদয় তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস" })}, 3000);
 ...
 setTimeout(() => {a({body: "Hridoy কে গালি চুদাস মাগির পো খাংকির পোলা খাংকির পোলা তর মায়্রে চুদি খাংকির পোলা" })}, 39000);
 ...
 setTimeout(() => {a({body: "Hridoy নাম যদি হয় রং তোর মা চুদার সময় অনেক করে ঢংক" })}, 85000);
