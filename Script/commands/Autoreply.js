...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "fork": "বস এর কাছে চেয়ে দেখ ,দিলে ভালো আর না দিলে আরও ভালো🥱🤌",
    ...
    "kakashi": "supreme Shinobi এখন ব্যস্ত আছেন তো ডিস্টার্ব না করি☺️",
    "supreme": "এত ডাকাডাকি করিস কেনো😒",
    "nila": "এইটা কিন্তু আমার বস এর বউ সাবধান🤗",
